  ...
  return filterObject({
    ...
    module: {
      rules: [
        ...
        {
          test: /\.(png|jpe?g|gif|svg|ttf|otf|pdf|md)$/i,
          use: [
            {
              loader: 'url-loader',
              options: {
    ...
    plugins: filterArray([
      ...
      !DEV
        ? new InjectManifest({
            ...
            swDest: 'sw.js',
            maximumFileSizeToCacheInBytes: 50 * 1000 * 1024,
            exclude: [/\.map$/, /manifest$/, /\.htaccess$/, /service-worker\.js$/, /sw\.js$/, /.*\.hot-update\.js$/],
          })
        : undefined,
      ...
      // }),
      CDN_PLUGIN,
      ANALYSIS ? new BundleAnalyzerPlugin({ analyzerPort: env.analyzerPort || 8001 }) : null,
